export const MyStory = () => {
  return (
    ...
    //   <div className="md:p-8 xsm:p-10  text-[#555]  xsm:rounded-none md:rounded-xl py-12 px-4    max-w-[1200px] w-full mx-auto">
    ...
    //         j'ai pu aider des centaines d'enfants à acquérir leur autonomie et à
    ...
    //         analyser. Bref, des compétences pédagogiques pour aider les enfants
    //         à trouver et exploiter le meilleur d'eux-même...Enseigner aux petits
    //         et aux plus grands m'a également appris à cultiver patience,
    ...
    //         grand nombre tous les bienfaits quotidiens de cette pédagogie, de
    //         cet apprentissage dynamique du bien-être.
    //       </p>

    //       <p>
    //         C'est dans cette suite logique, que j'ai quitté sans nostalgie mais
    //         avec fierté les cours de récré, les cartables, pour devenir à mon
    //         tour sophrologue.
    //       </p>
