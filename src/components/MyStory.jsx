    ...
    <div className="bg-[rgba(255,255,255,0.6)] p-10 flex flex-col justify-evenly  relative top-0 right-0 left-0 bottom-0 ">
      ...
      <ul className="h-full  ">
        ...
        <li>
          ...
          moment-là, que j'ai découvert la sophrologie, une discipline qui m'a
          aidée à me reconnecter avec moi-même, à prendre conscience de
          l'urgence de prendre soin de moi, physiquement et mentalement.
        </li>
        <br />
        <li>
