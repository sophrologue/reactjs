...
export const Career = () => {
  return (
    <div className="flex flex-col justify-between my-10 p-6 bg-orange-50  rounded-xl">
      {/* <img src={profileImg} alt="profile img" className="h-[400px]   " /> */}

      <div className=" flex justify-center gap-10 p-6  ">
        <div className="flex flex-col border-1 border-white rounded-xl  gap-8 justify-center w-[300px] p-8 text-4xl bg-orange-400 text-white">
