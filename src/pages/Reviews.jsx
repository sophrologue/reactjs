export const Reviews = () => {
  const reviews = [
    {
      ...
      rating: "5/5",
      date: "05.2023",
      comment: `J’ai consulté Mme Fabrici afin qu’elle m’aide dans la gestion du stress et des émotions. Je suis ravie du protocole qu’elle a élaboré pour moi, en rapport avec mes besoins. C’est une sophrologue très professionnelle et toujours à l’écoute des demandes.
        Je suis maintenant outillée pour mettre en pratique les exercices appris et vivre de manière positive.
    ...
    },
    {
      ...
      date: "02.2023",
      rating: "5/5",
      comment: `Merci à toi Catherine de m'avoir appris à chasser le négatif et laisser entrer le positif.
        J'ai une préférence pour l'hypnose.
    ...
    },
    {
      ...
      date: "04.2022",
      rating: "5/5",
      comment: `Je vous la conseille vivement.
      Très bonne praticienne aide à la gestion du stress et de l 'anxieté.
    ...
    },
    {
      ...
      date: "2019",
      rating: "5/5",
      comment: `Une grande aide personnalisée, beaucoup d'écoute, une découverte pour moi qui n'avais jamais "goûté" a ce type de soins.
      Catherine FABRICI est une professionnelle, qui fait passer l'intérêt de ses patients/client  avant le siens.
    ...
    },
    {
      ...
      date: "2019",
      rating: "5/5",
      comment: `La sophrologie avec Mme FABRICI, m'a énormément aidé à canaliser certaines choses enfouies, et m'a permis d'avancer sur mes projets sereinement.
      Elle a contribuée aussi à la réussite de mon ados qui était très timide à l'oral. Aujourd'hui il intervient oralement sans soucis et aborde ses exemens en toute sérénité.
      Merci beaucoup pour cette aide précieuse, cette écoute.
    ...
    },
    {
      ...
      date: "11.2019",
      rating: "5/5",
      comment: `Je conseille cette sophrologue amplement. C'est une personne qui prend le temps qui n'est pas pressé et qui essaye réellement de te faire du bien. Elle travaille avec les 3 capacités essentielles : harmonie, l'optimisme, et la confiance en soi.
      Elle a été là à un moment de ma vie utile. J'étais une étudiante qui stressais tout le temps a chaque examen je me mettais une pression de dingue et elle a réussi à m'apprendre à relativiser. Je suis venue à elle pour cette raison mais d'autres choses en moi se sont calmés en réalisant ces séances.
    ...
    },
    {
      ...
      date: "2019",
      rating: "5/5",
      comment: `Mme Fabricie est une sophrologue en or, elle a redonnée à ma fille de 11 ans une confiance en elle, qu elle avait malheureusement perdu.
      Ma fille se sent ressourcée dès qu elle sort d une séance.
    ...
    },
    {
      ...
      date: "10.2019",
      rating: "5/5",
      comment: `La Sophrologie avec Catherine Fabrici a vraiment répondu à mes attentes, c'est une personne qui par son l'écoute propose une méthode adaptée a chacun.
    ...
    },
    {
      ...
      date: "2019",
      rating: "3/5",
      comment: `Merci Mme Fabrici pour votre aide
    ...
    },
    {
      ...
      date: "10.2020",
      rating: "5/5",
      comment: `Je recommande vivement très à l'écoute et très professionnelle.q
  ...
  console.log(reviews);
  return (
    <div className=" flex flex-col my-5 gap-4 w-screen xsm:px-10   max-w-[70rem] mx-auto">
      <h1 className="text-2xl text-center">Catherine Fabrici sophrologue</h1>
      ...
      <button className="w-ful ">
        ...
        >
          {" "}
          <button className="p-4 w-60 rounded-xl bg-green-500 border  text-white">
