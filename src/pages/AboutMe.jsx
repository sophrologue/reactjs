...
import backgroundImg from "../assets/flower-fieldlg.jpeg";
    ...
    <div className="p-10">
      <div className="flex items-center justify-center gap-4">
        <button
          ...
          className="bg-green-700 bg- text-white w-[200px] h-[50px] border-r hover:brightness-110 duration-300"
        >
          Career
        </button>
        <button
