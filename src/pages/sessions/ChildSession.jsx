        ...
        <ul className="h-full  ">
          ...
          <li className="text-orange-600 font-bold ">
            ...
            <ul className="text-gray-800 font-normal ml-4">
              <li>
                - Avec la SOPHROLOGIE votre enfant aura les outils pour
                retrouver le calme, l'attention, la concentration.
              </li>
              <li>
                - Sa pratique permettra d'équilibrer le trop plein d'énergie, de
                se libérer des tensions, des fatigues, des colères.
              </li>
              <li>
